  ...
  return (
    <section className="relative container px-2 mx-auto py-6 mb-20">
      <div className="relative flex items-center flex-col gap-8 lg:gap-14 lg:flex-row justify-between flex-wrap /px-4 md:pl-6 md:pr-14">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }} className="flex flex-col items-center lg:items-start max-w-[510px] text-center lg:text-left">
          <motion.h1
            animate={{ color: "var(--primary)" }}
            transition={{ delay: 1.8, duration: 1 }}
            className="relative font-tomato-grotesk font-semibold text-4xl lg:text-5xl xl:text-[56px] leading-tight"
          >
